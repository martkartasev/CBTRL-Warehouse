...
public class ArticulationChainComponent : MonoBehaviour
{
    ...
    public class DriveController
    {
        ...
        public DriveController(ArticulationBody articulationBody)
        {
            ...
            // if (articulationBody.name == "link_5") initialPosition = new ArticulationReducedSpace(86.25f);
        ...
        public void ResetArticulationBody()
        {
            ...
            if (articulationBody.name == "link_5") articulationBody.jointPosition = new ArticulationReducedSpace(Mathf.Deg2Rad * 86.25f);
            switch (articulationBody.dofCount)
            {
                case 1:
                    ...
                    articulationBody.SetDriveTarget(ArticulationDriveAxis.X, articulationBody.jointPosition[0]);
                    break;
                case 2:
